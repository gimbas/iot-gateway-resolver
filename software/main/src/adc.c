...
void adc_init()
{
    ...
    ADC0->SINGLECTRL = ADC_SINGLECTRL_AT_4CYCLES | ADC_SINGLECTRL_NEGSEL_VSS | ADC_SINGLECTRL_POSSEL_APORT0XCH5 | ADC_SINGLECTRL_REF_2V5 | ADC_SINGLECTRL_RES_12BIT;
    ...
    ADC0->CTRL = ADC_CTRL_CHCONREFWARMIDLE_KEEPPREV | (15 << _ADC_CTRL_TIMEBASE_SHIFT) | (0 << _ADC_CTRL_PRESC_SHIFT) | ADC_CTRL_ASYNCCLKEN_ALWAYSON | ADC_CTRL_ADCCLKMODE_ASYNC | ADC_CTRL_WARMUPMODE_KEEPADCWARM;
}
