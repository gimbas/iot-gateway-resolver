...
void svpwm_init()
{
    ...
    TIMER0->DTTIME = TIMER_DTTIME_DTPRESC_DIV16 | ((20 << _TIMER_DTTIME_DTFALLT_SHIFT) & _TIMER_DTTIME_DTFALLT_MASK) | ((20 << _TIMER_DTTIME_DTRISET_SHIFT) & _TIMER_DTTIME_DTRISET_MASK);
